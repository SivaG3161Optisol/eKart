...
enum Brand { MAYBELLINE , ALVA, CLINIQUE, PACIFICA} // Imprt : You have to change the corresponding brand on the api too.

final brandValues = EnumValues({"pacifica": Brand.PACIFICA});
